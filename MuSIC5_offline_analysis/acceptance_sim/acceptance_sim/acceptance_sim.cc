...
int main(int argc,char** argv)
{
    ...
    // User Action classes
    PrimaryGeneratorAction* gen_action = new PrimaryGeneratorAction(detector, "/Users/scook/code/MuSIC/simulation/MuSIC_5_detector_sim/MuSIC5/g4blout/monitor6_By-0T_cor.root");
